...
<html>
  ...
  <head>
    <title> Restaurant Login | FoodShala </title>
  </head>

  <link rel="stylesheet" type = "text/css" href ="css/delete_food_items.css?v=<?php echo time(); ?>">
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse " id="myNavbar">
          ...
          <ul class="nav navbar-nav navbar-right">
            ...
            <li class="active"> <a href="managerlogin.php">RESTAURANT CONTROL PANEL</a></li>
