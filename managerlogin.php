...
<html>
  ...
  <link rel="stylesheet" type = "text/css" href ="css/managerlogin.cssv=<?php echo time(); ?>">
  ...
  <body>
    ...
    <div class="container">
    <div class="jumbotron">
     <h1>Hi Restaurant Manager,<br> Welcome to <span class="edit" style="color:#00BFFF; text-shadow:#483D8B"> FoodShala </span></h1>
     <br>
