...
$cleardb_username = $cleardb_url["b594c467795321"];
$cleardb_password = $cleardb_url["4c14ee23"];
...
<div style="background-color:#E6E6FA">
    <div class="wide">
        ...
        <div class="col-xs-2 logo"><img src="images\yatinlogo.jpg"></div>
        <div class="col-xs-5 line"><hr></div>
        <div class="tagline" style="color:green; margin-top:100px;">Good Food and Great Vibes <span style="color:#00BFFF; text-shadow: 1px 2px #483D8B">@FoodShala..!</span></div>
    </div>
    <br>
    <div class="orderblock" >
    <h2>Feeling Hungry?</h2>
    <center><a class="btn btn-info btn-lg" href="customerlogin.php" role="button" > Order Food </a></center>
    </div>
	</div>
