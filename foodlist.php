...
<html>
  ...
  <head>
    <title> Explore | FoodShala </title>
  </head>
<link rel="preconnect" href="https://fonts.gstatic.com">
<link href="https://fonts.googleapis.com/css2?family=RocknRoll+One&display=swap" rel="stylesheet">
  <link rel="stylesheet" type = "text/css" href ="css/foodlist.css?v=<?php echo time(); ?>">
...
?>
    ...
    <div class="carousel-inner">
      ...
      <div class="carousel-caption " style="font-size:40px; font-style:italic; text-shadow:2px 2px grey">
	  FoodShala,a solution to all your hungerrrrr!
      </div>
      </div>
      ...
      <div class="carousel-caption " style="font-size:40px; font-style:italic; text-shadow:2px 2px grey">
	  Explore all the tastiest snacks,cuisines,veg-nonveg meals!
      </div>
      ...
      <div class="carousel-caption " style="font-size:40px; font-style:italic; text-shadow:2px 2px grey">
	  Made with love, by @Yatin Mahajan!
      </div>
    </div>
...
<div class="jumbotron">
  <div class="container text-center">
    <h1 style="font-family: 'RocknRoll One', sans-serif;" >Welcome To FoodShala</h1>      
...
<div class="container" style="width:95%; background-color:#00BFFF">
...
?>
<div class="col-md-3" style="border-radius:100px; padding: 30px" >
