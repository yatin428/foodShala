...
<html>
  ...
  <link rel="stylesheet" type = "text/css" href ="css/COD.css?v=<?php echo time(); ?>">
...
<h2 class="text-center"> Thank you for Ordering at FoodShala! The ordering process is now complete.</h2>
