...
<html>
  ...
  <head>
    <title> Guest Login | FoodShala </title>
  </head>

  <link rel="stylesheet" type = "text/css" href ="css/managerlogin.css?v=<?php echo time(); ?>">
  ...
  <body>
    ...
    <div class="container">
    <div class="jumbotron">
     <h1>Hi Guest,<br> Welcome to <span class="edit" style="color:#00BFFF; "> FoodShala </span></h1>
     <br>
