<html>
<head>
    <title> Guest Signup | FoodShala </title>
  </head>

  <link rel="stylesheet" type = "text/css" href ="css/managersignup.css?v=<?php echo time(); ?>">
  ...
  <body>
    ...
    <div class="container">
    <div class="jumbotron">
     <h1>Hi Guest, <br> Welcome to <span class="edit"> Restaurant </span></h1>
     <br>
   <p>Get started by creating your FoodShala account</p>
    </div>
    </div>
